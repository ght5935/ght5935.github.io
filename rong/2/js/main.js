    ...
    var n = i(7),
      ...
      h = (function () {
        return {
          ...
          dialogue: [
            { type: 6, name: "小菜°🍀", txt: "2023年了，我们去放烟花吧！" },
            {
              type: 2,
              name: "小蓉ღ💌ღ",
              txt: "天还这么亮，现在放烟花也不好看。",
            },
            { type: 2, name: "小蓉ღ💌ღ", txt: "再说你那有烟花吗？" },
            { type: 6, name: "小菜°🍀", txt: "我当然有烟花啦。" },
            { type: 6, name: "小菜°🍀", txt: "你那有打火机吗？" },
            { type: 2, name: "小蓉ღ💌ღ", txt: "没有呀～" },
            { type: 6, name: "小菜°🍀", txt: "那你是怎么点燃我的心的？" },
            { type: 2, name: "小蓉ღ💌ღ", txt: "。。。" },
            { type: 2, name: "小蓉ღ💌ღ", txt: "可是我的心还没有被你点燃呀。" },
            { type: 6, name: "小菜°🍀", txt: "别慌，我去买个打火机先。" },
            { type: 2, name: "小蓉ღ💌ღ", txt: "打火机可点不燃我的心。" },
            {
              type: 6,
              name: "小菜°🍀",
              txt: "天快黑了，我要为你点燃整片天空。",
