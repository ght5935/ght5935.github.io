!(function (t) {
  ...
  function (t, e, i) {
    ...
    var n = i(7),
      ...
      h = (function () {
        return {
          ...
          dialogue: [
            { type: 6, name: "小菜°🍀", txt: "2020年了，我们去放烟花吧！" },
            {
              type: 2,
              name: "空欢ღ💌ღ",
              txt: "天还这么亮，现在放烟花也不好看。",
            },
            { type: 2, name: "空欢ღ💌ღ", txt: "再说你那有烟花吗？" },
            { type: 6, name: "小菜°🍀", txt: "我当然有烟花啦。" },
            { type: 6, name: "小菜°🍀", txt: "你那有打火机吗？" },
            { type: 2, name: "空欢ღ💌ღ", txt: "没有呀～" },
            { type: 6, name: "小菜°🍀", txt: "那你是怎么点燃我的心的？" },
            { type: 2, name: "空欢ღ💌ღ", txt: "。。。" },
            { type: 2, name: "空欢ღ💌ღ", txt: "可是我的心还没有被你点燃呀。" },
            { type: 6, name: "小菜°🍀", txt: "别慌，我去买个打火机先。" },
            { type: 2, name: "空欢ღ💌ღ", txt: "打火机可点不燃我的心。" },
            {
              type: 6,
              name: "小菜°🍀",
              txt: "天快黑了，我要为你点燃整片天空。",
          ...
          fireWords:
            "你的眼睛|真好看|里面有|日月冬夏|晴雨山川|但是|我的眼睛|更好看|因为|里面有你",
          skyColor: "hsla({hue}, 60%, {lightness}%, 0.2)",
          fireOpt: { wordInterval: 3e3 },
          shape: { gap: 3 },
          word: { size: 70, y: u / 4 },
    ...
    (h.dialogueOpt.interval = a.default.transTime(h.dialogueOpt.interval, 120)),
      ...
      (h.fireOpt.wordInterval = a.default.transTime(
        h.fireOpt.wordInterval,
        180
      )),
    ...
    var a = (function () {
      ...
      d = (function (t) {
        function e() {
          ...
          return (
            (v.opacity = h.default.random(y, 1)),
            (v.speed = d * (1 + Math.random())),
            (v.direction = Math.random() > 0.5 ? 0.5 : -0.5),
            v
          );
        }
        return (
          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                document.addEventListener(
                  ...
                  (e.onclick = function () {
                    "on" == this.getAttribute("class")
                      ? (this.setAttribute("class", "off"), t.pause())
                      : (this.setAttribute("class", "on"), t.play());
                  });
              },
            },
            {
            ...
            { key: "testLoop", value: function () {} },
            {
              key: "loop",
              value: function () {
                switch (
                  (requestAnimationFrame(this.loop.bind(this)),
                  ++this.time >= 6e4 || this.time,
                  this.renderFall(),
                  this.status)
                ) {
                  case 1:
            ...
            },
            {
              ...
              value: function () {
                switch (
                  ...
                  case "snow":
                    this.time % l.default.snowInterval == 0 &&
                      this.fallDots.push(new v.default(l.default.snow));
                    break;
                  case "heart":
                    this.time % l.default.heartInterval == 0 &&
                      this.fallDots.push(new w.default(l.default.heart));
                    break;
                  case "mix":
                    this.time % l.default.snowInterval == 0 &&
                      this.fallDots.push(new v.default(l.default.snow)),
                ...
                for (var t = this.fallDots.length - 1; t >= 0; --t)
                  !this.fallDots[t].render(this.fallCtx) &&
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (t.clearRect(0, 0, l.default.width, l.default.height),
                  (t.fillStyle =
                  ...
                  --this.dialogueOpt.speed <= 0 &&
                    ((this.dialogueOpt.speed = l.default.dialogueOpt.speed),
                    ++this.dialogue.current),
                  t.fillText(
                    this.dialogue.name +
                      "：" +
                      this.dialogue.txt.slice(0, this.dialogue.current),
                    20,
                    50
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.fireworkCtx.fillStyle =
                  "hsla(210, 60%, 5%, " +
                  0.01 * (20 - (this.sunsetTime / l.default.sunset) * 20) +
                  ")"),
            ...
            },
            {
              ...
              value: function () {
                if (0 == this.fireWords.length)
                  return (
                    (this.fireOpt.end = !0), void (this.fireOpt.time = 180)
                  );
                --this.fireOpt.wordInterval <= 0 &&
                  (this.getDotsPostion(this.fireWords.shift(), !0),
                  (this.fireOpt.wordInterval = l.default.fireOpt.wordInterval));
              },
            },
            {
              key: "createDenseFire",
            ...
            },
            {
              key: "renderFireworks",
              value: function () {
                (this.fireworkCtx.fillStyle = l.default.skyColor
                  .replace("{lightness}", 5 + 15 * this.skyColor.lightness)
                  .replace("{hue}", this.skyColor.hue)),
                  this.fireworkCtx.fillRect(0, 0, this.width, this.height),
                  this.createFireworks(),
                  (this.skyColor = { lightness: 0, hue: 210 });
                for (var t = this.fireworks.length - 1; t >= 0; --t)
                  (this.skyColor =
                    this.skyColor.lightness >=
                    this.fireworks[t].getSkyColor().lightness
                      ? this.skyColor
            ...
            },
            {
              ...
              value: function () {
                --this.fireworkTime <= 0 &&
                  (this.fireworks.push(new b.default(l.default.fireworks)),
                  (this.fireworkTime =
                    0 |
                    h.default.random.apply(
                      h.default,
            ...
            },
            {
              ...
              value: function () {
                if (
                  (this.createCanvas(), this.createTitleDots(), this.titleOpt)
                ) {
              ...
              value: function () {
                ...
                if (!this.titleOpt.start) {
                  ...
                  (this.titleDots = []),
                    ...
                    (this.titleOpt.time =
                      l.default.titleOpt.e + l.default.titleOpt.delay),
                    (l.default.word.y += l.default.titleOpt.distance);
                  this.getDotsPostion(this.titleWords.shift()).forEach(
                    function (e) {
                      var i = {
                        x: e.x,
                        y: e.y,
              ...
              value: function (t, e) {
                ...
                return (
                  r.forEach(function (t, r) {
                    ...
                    (h =
                      s % 2 == 0
                        ? l.default.width / 2 + (r - s / 2) * o + 0.5 * o
                        : l.default.width / 2 + (r - Math.floor(s / 2)) * o),
                      i.shapeMaker.write({ txt: t, x: h, y: a, size: o });
            ...
            },
            {
              ...
              value: function (t, e) {
                var i = e.width,
                  ...
                  u = void 0;
                n >= s
                  ? ((a = 0), (u = r), (o = ((n - s) * i) / 2), (l = r * s))
                  : n < s &&
                    ((o = 0), (l = i), (a = (r - i / s) / 2), (u = i / s)),
  ...
  function (t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var r = { bg: i(9), musicon: i(10), musicoff: i(11) };
    e.default = r;
  },
  function (t, e, i) {
      ...
      v = (function () {
        function t() {
          ...
          if (
            ...
            (this.x =
              i ||
              h.default.random(l.default.width / 8, (7 * l.default.width) / 8)),
            (this.y = o),
            (this.xEnd = a || this.x),
            (this.yEnd =
              u ||
              h.default.random(
                l.default.height / 8,
                (3 * l.default.height) / 8
              )),
            (this.size = c),
            (this.opacity = b),
            (this.velocity = -Math.abs(w)),
            (this.wait = k || h.default.random(30, 60)),
            (this.radius = h.default.random.apply(h.default, n(v))),
            (this.GRAVITY = y),
            (this.hue = (360 * Math.random()) | 0),
            (this.color = _ || "hsla(" + this.hue + ",80%,60%,1)"),
            (this.status = 1),
            z)
          ) {
            this.type = "words";
            var T = { xStart: this.xEnd, yStart: this.yEnd };
            this.particles = z.map(function (t) {
              return new p.default(h.default.extend({}, t, T, S));
            });
          } else
            (this.count = 0 | h.default.random.apply(h.default, n(O))),
              (this.particles = []),
                ...
                switch (this.status) {
                  case 1:
                    return (
                      ...
                      (t.fillStyle = this.color),
                      t.arc(
                        this.x + Math.sin(2 * Math.PI * Math.random()) / 1.2,
                        this.y,
                        this.size,
                        0,
                        2 * Math.PI,
                  ...
                  case 3:
                    ...
                    return (
                      t.restore(), (this.opacity -= 0.01), this.opacity > 0
                    );
                }
              },
            },
              ...
              value: function () {
                for (
                  var t =
                    ...
                    o = this.canvas.width,
                    a = this.size,
                    l = this.ctx.getImageData(0, s, o, a).data,
                    u = [],
                    h = 0,
                    f = s,
                    c = 0,
          ...
          o(e, [
            {
              ...
              value: function () {
                return --this.e < 0
                  ? ((this.x = this.xEnd), (this.y = this.yEnd), !0)
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  ...
                  t.beginPath(),
                  (t.fillStyle = this.color),
                  t.moveTo(this.x + 0.5 * this.size, this.y + 0.3 * this.size),
                  t.bezierCurveTo(
                    this.x + 0.1 * this.size,
                    this.y,
                    this.x,
